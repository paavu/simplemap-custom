...
if ( ! class_exists( 'Simple_Map' ) ) {
	...
	class Simple_Map {
		...
		function add_distance_field( $radius_value, $units ) {
			...
			return array(
				'label' => apply_filters( 'sm-search-label-distance', __( '<div class="title">Select a distance: </div>', 'simplemap' ), $post ),
			...
			function searchLocationsNear(searchData) {
				...
				jQuery.get( searchUrl, {}, function(data) {
					...
					if(searchData.state!='1'){
						results.innerHTML = "<h3>Workshops In "+searchData.state+"</h3>";
					}else{
					...
					if(searchData.address=='' && searchData.state=='1'){
						...
						var newHtml='<a id="backclick" href="#">Back To states</a>';
						results.innerHTML += newHtml;
